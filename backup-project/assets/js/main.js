!(function (e) {
    ...
    e(".loader-wrap").length > 0 &&
      e(function () {
        ...
        t.to(".loader-wrap-heading .load-text , .loader-wrap-heading .cont", {
          ...
          t.to(".loader-wrap", { y: -1500 }),
          t.to(".loader-wrap", { zIndex: -1, display: "none" });
      }),
    ...
    e(window).on("scroll", function () {
      e(this).scrollTop() > 500
        ? e(".sticky-wrapper").hasClass("sticky") ||
          e(".sticky-wrapper").addClass("sticky").stop(!0, !0).slideDown(300)
        : e(".sticky-wrapper").hasClass("sticky") &&
          e(".sticky-wrapper")
            .stop(!0, !0)
            .slideUp(300, function () {
              e(this).removeClass("sticky").show();
            });
    }),
    t(".onepage-nav"),
    t(".scroll-down"),
  ...
  e("[data-bg-src]").length > 0 &&
    ...
    e(".th-slider").each(function () {
      var t = e(this),
          ...
          pagination: {
            ...
            renderFraction: function (e, t) {
              return (
                '<span class="' +
                e +
                '"></span> <span class="line"></span> <span class="' +
                t +
                '"></span>'
              );
            },
          ...
          on: {
            init: function () {
              ...
              for (let a = 0; a < t.slides.length; a++)
                e(t.slides[a])
                  .find(".img")
                  .attr({ "data-swiper-parallax": 0.75 * t.width });
            },
            resize: function () {
              this.update();
            },
        ...
        u = t.attr("data-slider-options");
      if (u)
        try {
          (u = JSON.parse(u)), (d = e.extend({}, d, u));
        } catch (e) {
    ...
    e("#slider").on("input change", (t) => {
      ...
      e(".foreground-img").css("width", a + "%"),
        e(".slider-button").css("left", `calc(${a}% - 18px)`);
    }),
    ...
    e(".testi-card-tab").length &&
      e(".testi-card-tab").activateSliderThumbs({
        sliderTab: !0,
        tabButton: ".tab-btn",
      }),
    ...
    document.querySelectorAll(".testi-box-tab .tab-btn").forEach(function (e) {
      e.addEventListener("mouseenter", function () {
        let e = this.querySelector("img").getAttribute("src");
        document.querySelector(".testi-img img").setAttribute("src", e);
      });
    }),
    e(".testi-box-tab .tab-btn").hover(function () {
      var t = e(this).find("img").attr("src");
      e(".testi-img img").attr("src", t);
    });
  var i,
    r,
    l,
    ...
    (e.fn.sectionPosition = function (t, a) {
      e(this).each(function () {
        ...
        (n = Math.floor(l.height() / 2)),
          (o = l.attr(t)),
          (s = l.attr(a)),
          (i = f(e(s).css("padding-top"))),
          (r = f(e(s).css("padding-bottom"))),
          "top-half" === o
  ...
  e("[data-sec-pos]").length &&
    ...
    e(".filter-active").imagesLoaded(function () {
      ...
      e(".load-more-btn").on("click", function () {
        ...
        e(".plus-button").on("click", function () {
          var t = e(this),
            a = t.find("i");
          a.addClass("fa-plus"),
            setTimeout(function () {
              a.removeClass("fa-spin-plus");
            }, 1e3),
            t
              .closest(".slider-counter-wrapp")
              .find(".popup-more")
              .removeClass("d-none");
        }),
        e(".popup-close").on("click", function () {
          e(this).closest(".popup-more").addClass("d-none");
        });
    }),
    ...
    e(window).on("scroll", function () {
      !(function (t, a = 0) {
        var n = e(window).scrollTop(),
          o = n + e(window).height(),
          s = e(t).offset().top;
        return s + e(t).height() - parseInt(a) <= o && s >= n;
      })(".th-screen", 200)
  ...
  var y = document.getElementById("filt-monthly"),
    b = document.getElementById("filt-yearly"),
    w = document.getElementById("switcher"),
    C = document.getElementById("monthly"),
    k = document.getElementById("yearly");
  e(".pricing-tabs").length &&
    (y.addEventListener("click", function () {
      (w.checked = !1),
        y.classList.add("toggler--is-active"),
    ...
    b.addEventListener("click", function () {
      (w.checked = !0),
        ...
        y.classList.remove("toggler--is-active"),
        C.classList.add("hide"),
        k.classList.remove("hide");
    }),
    w.addEventListener("click", function () {
      b.classList.toggle("toggler--is-active"),
        y.classList.toggle("toggler--is-active"),
  ...
  if (e(".text-anime").length) {
    document.querySelectorAll(".text-anime").forEach((e) => {
  ...
  gsap.registerPlugin(ScrollTrigger);
  new SplitType(".title-ani", { types: "chars" });
  if (
    (gsap.registerPlugin(ScrollTrigger),
    gsap.registerPlugin(ScrollTrigger, SplitText),
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".split-text").forEach((e) => {
        e._split && (e._split.revert(), (e._split = null));
        const t = new SplitText(e, { type: "words" });
        (e._split = t),
          gsap.set(t.words, {
            opacity: 0,
            scale: (e) => (e % 2 == 0 ? 0 : 2),
    ...
    document.querySelectorAll(".hover-reveal").length > 0)
  ) {
    document.querySelectorAll(".hover-reveal").forEach((e, t) => {
        ...
        setInterval(
          (function (e, t) {
            const a = t.getBoundingClientRect(),
              ...
              o = e.clientY - a.y;
            t.children[0] &&
              (t.children[0].style.transform = `translate(${n}px, ${o}px)`);
          })(t, e),
          100
        );
      });
  ...
  if (e(".gallery-row").length > 0) {
    document.querySelectorAll(".gallery-row .gallery-box").forEach((e) => {
      gsap.set(e, { scale: 0 }),
        gsap.to(e, {
          duration: 1.2,
          scale: 1,
  ...
  if (document.querySelectorAll(".cursor , cursor2").length > 0) {
    ...
    TweenMax.to({}, 0.016, {
      ...
      onRepeat: function () {
        (S += (A - S) / 9),
          (P += (E - P) / 9),
          TweenMax.set(T, { css: { left: S - 12, top: P - 12 } }),
          TweenMax.set(x, { css: { left: A, top: E } });
      },
    }),
      e(document).on("mousemove", function (e) {
        (A = e.clientX), (E = e.clientY);
      }),
      e(".btn").on("mouseenter", function () {
        x.addClass("active"), T.addClass("active");
      }),
      e(".btn").on("mouseleave", function () {
        x.removeClass("active"), T.removeClass("active");
      });
  }
  if (
    e(".cursor-picture").length &&
    document.querySelectorAll(".cursor-picture").length
  ) {
    const e = document.querySelectorAll(".cursor-picture"),
      t = document.querySelector(".gsap-cursor");
    let a = 0,
      n = 0,
      o = 0;
    const s = 100,
    ...
    (t.style.position = "relative"),
      ...
      t.addEventListener("mousemove", (e) => {
        d &&
          ((r = e.clientX - t.getBoundingClientRect().left),
          (l = e.clientY - t.getBoundingClientRect().top),
          (c = !0));
      }),
      gsap.ticker.add(() => {
        if (!c || !d) return;
        if (((c = !1), Math.hypot(r - a, l - n) < s)) return;
        (a = r), (n = l), o >= e.length && (o = 0);
        const t = e[o++];
        i.has(t) ||
          (i.add(t),
          gsap.set(t, {
            position: "absolute",
            left: r - t.naturalWidth / 2 + "px",
            top: l - t.naturalHeight / 2 + "px",
            scale: 0.8,
            opacity: 0,
            pointerEvents: "none",
            zIndex: 9999,
          ...
          gsap
            .timeline()
            .to(t, { opacity: 1, scale: 1, duration: 0.3, ease: "power2.out" })
            .to(t, { opacity: 1, duration: 0.1 })
            .to(t, { opacity: 0, scale: 0.8, duration: 0.3, ease: "power2.in" })
            .call(() => {
              i.delete(t);
            }));
      });
