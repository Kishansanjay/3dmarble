...
var require_with_selector_development = __commonJS({
  "node_modules/@tanstack/react-store/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef6 = React3.useRef, useEffect6 = React3.useEffect, useMemo4 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
function createSieveCache(max) {
  ...
  return {
    ...
    set(key, value) {
      ...
      if (cache.size >= max) {
        let node = hand == null ? void 0 : hand.next().value;
...
function createHistory(opts) {
  ...
  return {
    ...
    go: (index, navigateOpts) => {
      tryNavigation({
        task: () => {
          opts.go(index, (navigateOpts == null ? void 0 : navigateOpts.ignoreBlocker) ?? false);
          handleIndexChange({
            type: "GO",
            index
          });
    ...
    this.update = (newOptions) => {
      ...
      if (this.options.routeTree !== this.routeTree) {
        ...
        if (false) {
          ...
          if (false) globalThis.__TSR_CACHE__ = {
...
async function contextualize(router, lane, options, end, planSuccessfulLane, retainedEnd) {
  ...
  for (let index = options[6] ?? 0; index < end; index++) {
    ...
    try {
      ...
      const result = await (typeof (value == null ? void 0 : value.then) === "function" ? waitFor(value, signal) : value);
      if (signal.aborted) return [index, CANCELED_OUTCOME];
...
async function executeClientLane(router, location, matches, options) {
  ...
  try {
    ...
    while (retainedEnd < end && retainedEnd !== plannedBoundary) {
      ...
      if ((committed == null ? void 0 : committed.id) !== match.id || committed.status !== "success" || match.preload || (visible == null ? void 0 : visible.id) !== match.id || visible.status !== "success") break;
      retainedEnd++;
...
async function loadClientRoute(router, opts) {
  ...
  const done = (opts == null ? void 0 : opts.sync) ? new Promise((resolve) => settle = resolve) : Promise.resolve().then(run);
  const tx = [
    controller,
    redirects,
    location,
...
// node_modules/@tanstack/router-core/node_modules/seroval/dist/dev/index.js
...
// node_modules/@tanstack/router-core/node_modules/seroval-plugins/dist/dev/rolldown-runtime-D7D4PA-g.js
...
// node_modules/@tanstack/router-core/node_modules/seroval-plugins/dist/dev/web-CWqRG00W.js
  ...
  return (0, import_jsx_runtime3.jsxs)("div", {
    ...
    children: [
      ...
      show ? (0, import_jsx_runtime3.jsx)("div", { children: (0, import_jsx_runtime3.jsx)("pre", {
        ...
        children: (error == null ? void 0 : error.message) ? (0, import_jsx_runtime3.jsx)("code", { children: error.message }) : null
      }) }) : null
    ]
  });
}
...
function Asset(asset) {
  ...
  const innerHTML = React$116.useMemo(() => children === void 0 ? void 0 : { __html: children }, [children]);
  switch (asset.tag) {
    case "title":
...
function InlineCssStyle({ attrs, children, nonce }) {
  ...
  const innerHTML = React$116.useMemo(() => ({ __html: html }), [html]);
  return (0, import_jsx_runtime15.jsx)("style", {
    ...attrs,
...
function Script({ attrs, children, preventScriptHoist }) {
  ...
  React$116.useEffect(() => {
    ...
    if (attrs == null ? void 0 : attrs.src) {
      ...
      link2.href = attrs.src;
      const normSrc = link2.href;
